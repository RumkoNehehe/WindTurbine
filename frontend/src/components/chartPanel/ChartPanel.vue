    ...
    <BaseCard variant="light" class="flex">
      <div class="flex flex-row gap-4 justify-between w-full">
        <div class="flex flex-col gap-2">
          <label class="text-sm font-semibold text-gray-800"> Source </label>
        ...
        <div v-if="chartDataSource === 'live'" class="flex flex-col gap-2 h-full">
          <label class="text-sm font-semibold text-gray-800"> Data flow </label>
          <div class="pt-1">
            <BaseButton
              v-if="isPaused"
              variant="primary"
        ...
        <div class="flex flex-col gap-2 h-full">
          <label class="text-sm font-semibold text-gray-800"> Chart data </label>
          <div class="pt-1">
        ...
        <div v-if="chartDataSource === 'recorded'" class="flex flex-col gap-2 h-full">
          <label class="text-sm font-semibold text-gray-800"> Custom data </label>
          <div class="pt-1">
            <div class="flex flex-col gap-2">
              <label
        ...
        <RecordingSelect
          ...
          :selected-recording="selectedRecordingId"
          :recordings="recordings"
          @update:selected-recording="emit('update:selected-recording', $event)"
        />
      </div>
    </BaseCard>
  </BaseCard>
